...
/***/ function(module, exports, __webpack_require__) {
	...
	var productEvents = __webpack_require__(37);
	var orderEvents = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var ordersUI = __webpack_require__(12);
	var orderComplete = __webpack_require__(36);
	...
	var formNotFilled = function formNotFilled() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hbsCart = __webpack_require__(13);
	var cart = __webpack_require__(34);
	var orderTemplate = __webpack_require__(35);
	...
	var showOrderSuccess = function showOrderSuccess(data, total) {
	  if (cart.items.length > 0) {
	    $('#checkout-btn').show();
	    var cartTemplate = hbsCart({ items: cart.items, total: total });
	...
	var getOrdersSuccess = function getOrdersSuccess(data) {
	  var orderHBS = orderTemplate({ orders: data.orders });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td>"
	    ...
	    + "\">\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,1,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"1\">1</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,2,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"2\">2</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,3,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"3\">3</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,4,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"4\">4</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,5,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"5\">5</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,6,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"6\">6</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,7,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"7\">7</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,8,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"8\">8</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,9,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"9\">9</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,10,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"item-value","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"10\">10</option></select></td>\n      <td>\n        <button class=\"btn btn-danger item-delete glyphicon glyphicon-trash\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\"></button>\n        <button class=\"btn btn-success item-edit glyphicon glyphicon-pencil\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" ></button>\n      </td>\n    </tr>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td>"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "</td>\n      <td>"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.items : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      </td>\n      <td>$"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.orderPrice : stack1), depth0))
	    + ".00</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.complete : stack1), depth0))
	    + "</td>\n      <td>\n        <button class=\"btn btn-danger delete-order glyphicon glyphicon-trash\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\"></button>\n      </td>\n    </tr>\n";
	  ...
	  return "<table class=\"order-history-table\">\n  <thead>\n    <tr>\n      <th>Date</th>\n      <th>ID</th>\n      <th>Items</th>\n      <th>Total</th>\n      <th>Complete?</th>\n    </tr>\n  </thead>\n\n  <tbody>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowProduct = function onShowProduct(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.showProduct(id).then(ui.showProductSuccess).catch(ui.showProductFailure);
	};

	var onPageLoad = function onPageLoad() {
	  api.getProducts().then(ui.getProductsSuccess).catch(ui.getProductsFailure);
	};

	var addToCart = function addToCart(event) {
	  event.preventDefault();
	  var i = getFormFields(event.target);
	  var currentProduct = cart.items.find(function (item) {
	    if (item._id === i.item._id) {
	      return item;
	    }
	  });
	  if (currentProduct !== undefined) {
	    var currProdIndex = cart.items.indexOf(currentProduct);
	...
	var removeFromCart = function removeFromCart(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  var delObj = cart.items.find(function (item) {
	    if (item._id === id) {
	      return item;
	    }
	  });
	  var delObjInd = cart.items.indexOf(delObj);
	  cart.items.splice(delObjInd, 1);
	  orderEvents.onShowOrder();
	};

	var updateCart = function updateCart(event) {
	  var id = event.target.dataset.id;
	  var i = $('#' + id).val();
	  var currentProduct = cart.items.find(function (item) {
	    if (item._id === id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var maxItemSuccess = function maxItemSuccess() {
	  $("#show-form")[0].reset();
	  $("#myProductModal").modal("hide");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"productWindow hover12 column\">\n  <ul class=\"products\">\n    <li><figure><img src=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.img : stack1), depth0))
	    + "\" alt=\"picture\" style=\"width:200px;height:200px;\" class=\"show-product\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + " onclick=\"\" data-toggle=\"modal\" data-target=\"#myProductModal\"></figure></li>\n    <li>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</li>\n    <li>$"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
	    + ".00</li>\n  </ul>\n</div>\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"productWindow\">\n  <form id='show-form'>\n    <ul>\n      <li><input class=\"name hide\" name=\"item[name]\" type=\"text\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.name : stack1), depth0))
	    + "\" readonly></li>\n      <li><input class=\"price hide\" name=\"item[price]\" type=\"text\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.price : stack1), depth0))
	    + "\" readonly ></li>\n      <li><input class=\"description hide\" name=\"item[description]\" type=\"text\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.description : stack1), depth0))
	    + "\" readonly ></li>\n      <li><input class=\"id hide\" name=\"item[_id]\" type=\"text\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" readonly></li>\n    </ul>\n    <img src=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.img : stack1), depth0))
	    ...
	    + ".00 </h4>\n    <h5> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.description : stack1), depth0))
	    + " </h5>\n\n    <select class=\"quantity\" name=\"item[quantity]\">\n      <option value=\"1\">1</option>\n      <option value=\"2\">2</option>\n      <option value=\"3\">3</option>\n      <option value=\"4\">4</option>\n      <option value=\"5\">5</option>\n      <option value=\"6\">6</option>\n      <option value=\"7\">7</option>\n      <option value=\"8\">8</option>\n      <option value=\"9\">9</option>\n      <option value=\"10\">10</option>\n    </select>\n    <button class=\"button button--wapasha button--text-thick button--text-upper button--size-s add-to-cart\">Add to Cart</button>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cart = __webpack_require__(34);
	var stripe = __webpack_require__(44);
	var orderComplete = __webpack_require__(36);

	var onGetOrders = function onGetOrders(event) {
	  event.preventDefault();
	  api.getOrders().then(ui.getOrdersSuccess).catch(ui.failure);
	};
	...
	var onCreateOrder = function onCreateOrder(event) {
	  ...
	  if (orderComplete.getId() === '') {
	    api.createOrder(data).then(function (data) {
	      orderComplete.setId(data.order._id);
	      stripe.onCreateCharge(event, data.order);
	    }).catch(ui.failure);
	  } else {
	    api.updateOrder(orderComplete.getId(), data).then(function (data) {
	      onShowOrder();
	      stripe.onCreateCharge(event, data.order);
	    }).catch(ui.failure);
	  }
	...
	var onDeleteOrder = function onDeleteOrder(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.destroyOrder(id).then(ui.destroyOrderSuccess).then(function () {
	    onGetOrders(event);
	  }).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var destroyOrder = function destroyOrder(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/orders/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var orderAPI = __webpack_require__(43);
	var cart = __webpack_require__(34);
	var ordersUi = __webpack_require__(12);
	var orderComplete = __webpack_require__(36);

	var onCreateCharge = function onCreateCharge(event, order) {
	  event.preventDefault();
	  var handler = StripeCheckout.configure({
	    ...
	    token: function token(_token) {
	      ...
	      api.createCharge(credentials).then(function () {
	        var data = {
	          order: {
	            items: cart.getItems(),
	            complete: true
